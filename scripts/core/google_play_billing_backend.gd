...
# Wraps the GodotGooglePlayBilling 3.x addon (PBL 8.3.0). Non-consumables
...
#
# This is the extracted, behavior-preserving Google half of BillingManager's
# facade (#403) — logic is unchanged from the pre-facade BillingManager.

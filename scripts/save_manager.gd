...
static func save(c: CharacterData, path: String = DEFAULT_PATH, tree: SkillTree = null, tracker: MetaProgressionTracker = null, xp_tracker: OfflineXPTracker = null, cosmetic_inv: CosmeticInventory = null) -> Error:
	if c == null:
		return ERR_INVALID_PARAMETER
	var save_data := KittenSaveData.from_character(c, tree, tracker, xp_tracker, cosmetic_inv)

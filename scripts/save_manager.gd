...
static func save(c: CharacterData, path: String = DEFAULT_PATH, tree: SkillTree = null, tracker: MetaProgressionTracker = null, inventory: TokenInventory = null) -> Error:
	if c == null:
		return ERR_INVALID_PARAMETER
	var save_data := KittenSaveData.from_character(c, tree, tracker, inventory)

...
static func all_items() -> Array[ItemData]:
	...
	items.append(ItemData.make("healing_wand", "Mushroom-on-a-Stick", ItemData.Slot.WEAPON, ItemData.Rarity.COMMON, "magic_attack", 2.0, _SLEEPY))
	...
	items.append(ItemData.make("lullaby_scepter", "Moonbeam Scepter", ItemData.Slot.WEAPON, ItemData.Rarity.EPIC, "magic_attack", 6.0, _SLEEPY))
	...
	# Chonk Kitten — tank
	items.append(ItemData.make("heavy_club", "Cheap Tavern Pint", ItemData.Slot.WEAPON, ItemData.Rarity.COMMON, "attack", 3.0, _CHONK))
	items.append(ItemData.make("spiked_mace", "Iron-Banded Stein", ItemData.Slot.WEAPON, ItemData.Rarity.RARE, "attack", 5.0, _CHONK))
	items.append(ItemData.make("earthshaker_hammer", "Mighty Keg", ItemData.Slot.WEAPON, ItemData.Rarity.EPIC, "max_hp", 20.0, _CHONK))
	...
	items.append(ItemData.make("feather_wand", "Lollipop Wand", ItemData.Slot.WEAPON, ItemData.Rarity.COMMON, "magic_attack", 2.0, _SLEEPY))
	items.append(ItemData.make("cloud_staff", "Cloud-Puff Wand", ItemData.Slot.WEAPON, ItemData.Rarity.RARE, "magic_attack", 4.0, _SLEEPY))
	items.append(ItemData.make("starlight_caduceus", "Caduceus of Catnaps", ItemData.Slot.WEAPON, ItemData.Rarity.EPIC, "mp_regen", 0.5, _SLEEPY))
	...
	items.append(ItemData.make("oak_cudgel", "Wooden Tankard", ItemData.Slot.WEAPON, ItemData.Rarity.COMMON, "attack", 3.0, _CHONK))
	items.append(ItemData.make("bone_crusher", "Hefty Stein", ItemData.Slot.WEAPON, ItemData.Rarity.RARE, "attack", 6.0, _CHONK))
	items.append(ItemData.make("mountain_maul", "Golden Chalice of Ale", ItemData.Slot.WEAPON, ItemData.Rarity.EPIC, "attack", 9.0, _CHONK))
	...
	items.append(ItemData.make("shop_lullaby_wand", "Warm-Milk Ladle", ItemData.Slot.WEAPON, ItemData.Rarity.RARE, "mp_regen", 0.3, _SLEEPY, ItemData.Source.SHOP))
	...
	items.append(ItemData.make("shop_oak_mallet", "Sloshing Pint Glass", ItemData.Slot.WEAPON, ItemData.Rarity.COMMON, "attack", 3.0, _CHONK, ItemData.Source.SHOP))

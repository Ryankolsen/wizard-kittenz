...
func test_scene_has_required_nodes():
	var s := _instantiate()
	assert_not_null(s.get_node_or_null("Backdrop/Center/CenterH/Panel/VBox/Headline"))
	assert_not_null(s.get_node_or_null("Backdrop/Center/CenterH/Panel/VBox/TierName"))
	assert_not_null(s.get_node_or_null("Backdrop/Center/CenterH/Panel/VBox/ContentRow/SpriteRow/OldSprite"))
	assert_not_null(s.get_node_or_null("Backdrop/Center/CenterH/Panel/VBox/ContentRow/SpriteRow/NewSprite"))
	assert_not_null(s.get_node_or_null("Backdrop/Center/CenterH/Panel/VBox/ContentRow/StatDeltaList"))
	assert_not_null(s.get_node_or_null("Backdrop/Center/CenterH/Panel/VBox/ContinueButton"))
...
func test_populate_sets_headline_and_tier_name():
	...
	var headline: Label = s.get_node("Backdrop/Center/CenterH/Panel/VBox/Headline")
	var tier_name: Label = s.get_node("Backdrop/Center/CenterH/Panel/VBox/TierName")
...
func test_populate_sets_sprite_textures():
	...
	s.populate(CharacterData.CharacterClass.BATTLE_KITTEN, CharacterData.CharacterClass.BATTLE_CAT,
		{"max_hp": 10, "attack": 7, "defense": 1, "speed": 70.0},
		{"max_hp": 12, "attack": 9, "defense": 2, "speed": 75.0})
	var old_sprite: TextureRect = s.get_node("Backdrop/Center/CenterH/Panel/VBox/ContentRow/SpriteRow/OldSprite")
	var new_sprite: TextureRect = s.get_node("Backdrop/Center/CenterH/Panel/VBox/ContentRow/SpriteRow/NewSprite")
...
func test_populate_renders_one_row_per_stat_delta():
	...
	s.populate(CharacterData.CharacterClass.BATTLE_KITTEN, CharacterData.CharacterClass.BATTLE_CAT,
		{"max_hp": 10, "attack": 7, "defense": 1, "speed": 70.0},
		{"max_hp": 12, "attack": 9, "defense": 2, "speed": 75.0})
	var list: VBoxContainer = s.get_node("Backdrop/Center/CenterH/Panel/VBox/ContentRow/StatDeltaList")
...
func test_continue_pressed_emits_dismissed():
	var s := _instantiate()
	watch_signals(s)
	var btn: Button = s.get_node("Backdrop/Center/CenterH/Panel/VBox/ContinueButton")
	btn.pressed.emit()
